...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0">
    <button class="btn btn-light my-2 my-sm-0" type="submit"><i class="fa-sharp fa-solid fa-gears"></i>Setting</button>
     <button class="btn btn-light my-2 my-sm-0 ml-1" type="Contact us"><i class="fa-sharp fa-solid fa-phone-volume"></i>Conatac Us</button>
    
    </form> 
<!-- <a href="" class="btn btn-success mx-2">Setting</a>
